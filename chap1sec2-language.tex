...
\!\raisebox{3mm}{\smash{$\xymatrix@R=3mm@C=3mm{&x\ar@{-}[dl]_{\textup{\normalsize$x$}}\ar@{-}[dr]\\x\ar@{-}[rr]&&y}$}}
...
\rednote{Because of the symmetry in the definition, we can swap the 0 for an $n$, right?}
\end{shaded}
...
\rednote{I haven't read proposition \ref{needed17}.}
\end{shaded}
...
\begin{1.2.14 Presentations of inf-cats}
\begin{shaded}
