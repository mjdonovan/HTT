...
\begin{1.1.1 Goals and Obstacles}
...
%It is remarked that $\sCoNerve:\Delta\to\sCat$, when viewed as a functor $(\Delta)^\Delta\to(\sCat)^\Delta$, is cofibrant replacement, under a suitable model structure.
\end{shaded}
