...
\usepackage{latexsym,framed,color, amscd, amsfonts, eucal, mathrsfs, amsmath, amssymb, amsthm, xypic, multind,version}
%\usepackage{hyperref}
\input{MichaelsPartialmacros.tex}

%\def\excludeversion#1{\includeversion{#1}}

\includeversion{chapters}
\includeversion{Didn't Read}
\includeversion{Already Read}

\excludeversion{intro}

%% CHAPTER ONE
{
%\def\excludeversion#1{\includeversion{#1}}
\includeversion{1 Overview of Higher Category Theory}
\includeversion{1.1 Formalism}
\excludeversion{1.1.1 Goals and Obstacles}
\excludeversion{1.1.2 inf-Categories}
\excludeversion{1.1.3 Equivalences of Top Cats}
\includeversion{1.1.4 Simplicial Categories}
\includeversion{1.1.5 inf-cats vs simplicial cats}

\includeversion{1.2 language}
\excludeversion{1.2.1 Opposite of an inf-cat}
\includeversion{1.2.2 Mapping spaces}
\excludeversion{1.2.3 The homotopy category}
\excludeversion{1.2.4 Objects, morphisms, equivalences}
\excludeversion{1.2.5 inf-gpoids and classical homotopy}
\excludeversion{1.2.6 Commutativity vs coherence}
\excludeversion{1.2.7 Functors between higher cats}
\excludeversion{1.2.8 Joins of inf-cats}
\includeversion{1.2.9 Over- and under-categories}
\excludeversion{1.2.10 F. faithful; E. surj functors}
\excludeversion{1.2.11 Subcategories of inf-cats}
\excludeversion{1.2.12 Initial and final objects}
\excludeversion{1.2.13 Limits and colimits}
\excludeversion{1.2.14 Presentations of inf-cats}
\excludeversion{1.2.15 Set-Theoretic Technicalities}
\excludeversion{1.2.16 The inf-cat of spaces}
}


\excludeversion{TOC}
\excludeversion{chapter2onwards}
\excludeversion{Appendix}
...
\begin{1.1 Formalism}
\include{chap1sec1-formalism}
\end{1.1 Formalism}
\setcounter{section}{1}
\begin{1.2 language}
\include{chap1sec2-language}
\end{1.2 language}
...
\include{chap2sec1-leftfib}
\include{chap2sec2-equivalence}
\include{chap2sec3-midfib}
\include{chap2sec4-cartfib}
...
\include{chap3sec1-marked}
\include{chap3sec2-straight}
\include{chap3sec3-applications}
...
\include{chap4sec1-cofinal}
\include{chap4sec2-decomposition}
\include{chap4sec3-relative}
\include{chap4sec4-examples}
...
\include{chap5sec1-presheaves}
\include{chap5sec2-adjoint}
\include{chap5sec3-filtered}
\include{chap5sec4-access}
\include{chap5sec5-presentability}
...
\include{chap6sec1-definition}
\include{chap6sec2-sheaves}
\include{chap6sec3-geomorph}
\include{chap6sec4-ntopoi}
\include{chap6sec5-homotopy}
...
\include{chap7sec1-paracompact}
\include{chap7sec2-dimension}
\include{chap7sec3-proper}
