...
\usepackage{latexsym,framed,color, amscd, amsfonts, eucal, mathrsfs, amsmath, amssymb, amsthm, xypic, multind,version, graphicx}
%\usepackage{hyperref}
...
\xver{1.1.1 Goals and Obstacles}
\xver{1.1.2 inf-Categories}
\xver{1.1.3 Equivalences of Top Cats}
\xver{1.1.4 Simplicial Categories}
\xver{1.1.5 inf-cats vs simplicial cats}
\includeversion{1.2 language}
\xver{1.2.1 Opposite of an inf-cat}
\xver{1.2.2 Mapping spaces}
\xver{1.2.3 The homotopy category}
\xver{1.2.4 Objects, morphisms, equivalences}
\xver{1.2.5 inf-gpoids and classical homotopy}
\xver{1.2.6 Commutativity vs coherence}
\xver{1.2.7 Functors between higher cats}
\xver{1.2.8 Joins of inf-cats}
\xver{1.2.9 Over- and under-categories}
\xver{1.2.10 F. faithful; E. surj functors}
\xver{1.2.11 Subcategories of inf-cats}
\xver{1.2.12 Initial and final objects}
\xver{1.2.13 Limits and colimits}
\iver{1.2.14 Presentations of inf-cats}
\iver{1.2.15 Set-Theoretic Technicalities}
\iver{1.2.16 The inf-cat of spaces}
