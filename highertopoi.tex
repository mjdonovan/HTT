...
\excludeversion{1.1.4 Simplicial Categories}
\excludeversion{1.1.5 inf-cats vs simplicial cats}

\includeversion{1.2 language}
\excludeversion{1.2.1 Opposite of an inf-cat}
\excludeversion{1.2.2 Mapping spaces}
\includeversion{1.2.3 The homotopy category}
...
\excludeversion{1.2.9 Over- and under-categories}
